document.addEventListener("DOMContentLoaded", () => {
    ...
    // 3. عداد الوقت المستمر والدقيق جداً (محسوب من تاريخ 22 فبراير 2026)
    ...
    function updateLiveCounter() {
        ...
        // حسابات الوقت (الأيام الكلية المتراكمة، الساعات، الدقائق، الثواني)
        // تم إلغاء عملية باقي القسمة (% 365) ليعرض الأيام كاملة (مثل 125 يوم) وتستمر بالزيادة
